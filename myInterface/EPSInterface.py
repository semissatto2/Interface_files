...
class Ui_EPSInterface(object):
    def setupUi(self, EPSInterface):
        ...
        EPSInterface.resize(798, 626)
        EPSInterface.setAutoFillBackground(False)
        EPSInterface.setStyleSheet("QWidget{\n"
"background-color: qlineargradient(spread:pad, x1:0.511258, y1:0.167, x2:0.5, y2:0.994624, stop:0.0107527 rgba(51, 51, 51, 255), stop:0.698925 rgba(173, 173, 173, 255));\n"
"}\n"
"QLabel{\n"
...
"}")
        self.gridLayout = QtWidgets.QGridLayout(EPSInterface)
        ...
        self.LinkButtonBackEPS.setMaximumSize(QtCore.QSize(41, 16777215))
        font = QtGui.QFont()
        font.setPointSize(14)
        self.LinkButtonBackEPS.setFont(font)
        self.LinkButtonBackEPS.setStyleSheet("background-color: rgb(206, 206, 206);")
        self.LinkButtonBackEPS.setText("")
        icon = QtGui.QIcon()
